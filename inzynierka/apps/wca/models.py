...
class Competitions(models.Model):
    ...
    cityname = models.CharField(
        db_column="cityName", max_length=50
    )  # Field name made lowercase.
    countryid = models.CharField(
        db_column="countryId", max_length=50
    )  # Field name made lowercase.
    ...
    eventspecs = models.TextField(
        db_column="eventSpecs", blank=True, null=True
    )  # Field name made lowercase.
    wcadelegate = models.TextField(
        db_column="wcaDelegate", blank=True, null=True
    )  # Field name made lowercase.
    organiser = models.TextField(blank=True, null=True)
    venue = models.CharField(max_length=240)
    venueaddress = models.CharField(
        db_column="venueAddress", max_length=120, blank=True, null=True
    )  # Field name made lowercase.
    venuedetails = models.CharField(
        db_column="venueDetails", max_length=120, blank=True, null=True
    )  # Field name made lowercase.
    external_website = models.CharField(max_length=200, blank=True, null=True)
    cellname = models.CharField(
        db_column="cellName", max_length=45
    )  # Field name made lowercase.
...
class Continents(models.Model):
    ...
    recordname = models.CharField(
        db_column="recordName", max_length=3
    )  # Field name made lowercase.
...
class Countries(models.Model):
    ...
    continentid = models.CharField(
        db_column="continentId", max_length=50
    )  # Field name made lowercase.
...
class Ranksaverage(models.Model):
    personid = models.CharField(
        db_column="personId", max_length=10
    )  # Field name made lowercase.
    eventid = models.CharField(
        db_column="eventId", max_length=6
    )  # Field name made lowercase.
    ...
    continentrank = models.IntegerField(
        db_column="continentRank"
    )  # Field name made lowercase.
    countryrank = models.IntegerField(
        db_column="countryRank"
    )  # Field name made lowercase.
...
class Results(models.Model):
    competitionid = models.CharField(
        db_column="competitionId", max_length=32
    )  # Field name made lowercase.
    eventid = models.CharField(
        db_column="eventId", max_length=6
    )  # Field name made lowercase.
    roundtypeid = models.CharField(
        db_column="roundTypeId", max_length=1
    )  # Field name made lowercase.
    pos = models.SmallIntegerField()
    best = models.IntegerField()
    average = models.IntegerField()
    personname = models.CharField(
        db_column="personName", max_length=80, blank=True, null=True
    )  # Field name made lowercase.
    personid = models.CharField(
        db_column="personId", max_length=10
    )  # Field name made lowercase.
    personcountryid = models.CharField(
        db_column="personCountryId", max_length=50, blank=True, null=True
    )  # Field name made lowercase.
    formatid = models.CharField(
        db_column="formatId", max_length=1
    )  # Field name made lowercase.
    ...
    regionalsinglerecord = models.CharField(
        db_column="regionalSingleRecord", max_length=3, blank=True, null=True
    )  # Field name made lowercase.
    regionalaveragerecord = models.CharField(
        db_column="regionalAverageRecord", max_length=3, blank=True, null=True
    )  # Field name made lowercase.
...
class Rounds(models.Model):
    sorry_message = models.CharField(max_length=172, db_collation="utf8_general_ci")
...
class Scrambles(models.Model):
    scrambleid = models.PositiveIntegerField(
        db_column="scrambleId"
    )  # Field name made lowercase.
    competitionid = models.CharField(
        db_column="competitionId", max_length=32
    )  # Field name made lowercase.
...
class Profile(models.Model):
    ...
    wca_id = models.CharField(max_length=10, unique=True, blank=True, null=True)
